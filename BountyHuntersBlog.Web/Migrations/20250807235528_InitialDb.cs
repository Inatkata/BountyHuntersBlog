        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsApplicationUser = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hunters_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MissionPosts_AspNetUsers_TakerId",
                        column: x => x.TakerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "FactionMissionPost",
                columns: table => new
                {
                    FactionsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MissionPostsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FactionMissionPost", x => new { x.FactionsId, x.MissionPostsId });
                    table.ForeignKey(
                        name: "FK_FactionMissionPost_Factions_FactionsId",
                        column: x => x.FactionsId,
                        principalTable: "Factions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FactionMissionPost_MissionPosts_MissionPostsId",
                        column: x => x.MissionPostsId,
                        principalTable: "MissionPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MissionComments_Hunters_HunterId",
                        column: x => x.HunterId,
                        principalTable: "Hunters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MissionComments_MissionPosts_MissionPostId",
                        column: x => x.MissionPostId,
                        principalTable: "MissionPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissionLikes", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MissionLikes_Hunters_HunterId",
                        column: x => x.HunterId,
                        principalTable: "Hunters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MissionLikes_MissionPosts_MissionPostId",
                        column: x => x.MissionPostId,
                        principalTable: "MissionPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FactionMissionPost_MissionPostsId",
                table: "FactionMissionPost",
                column: "MissionPostsId");

            migrationBuilder.CreateIndex(
                name: "IX_Hunters_ApplicationUserId",
                table: "Hunters",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissionLikes_MissionPostId",
                table: "MissionLikes",
                column: "MissionPostId");
